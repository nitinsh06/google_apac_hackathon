...
export const HistoryView: React.FC<HistoryViewProps> = ({
  ...
  return (
    <div className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-6 overflow-y-auto">
      {/* Top Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <button
          ...
          onClick={onNewEntry}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs shadow-xs transition-colors cursor-pointer self-start sm:self-auto"
        >
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-3 sm:p-4 mb-6 space-y-3 shadow-xs">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-lg pl-9 pr-4 py-2 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
          />
        </div>
      ...
      {filteredEntries.length === 0 ? (
        <div className="p-12 text-center border border-dashed border-slate-300 rounded-2xl bg-white/50">
          ...
          <button
            onClick={onNewEntry}
            className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs transition-colors cursor-pointer shadow-xs"
          >
              ...
              >
                ...
                {entryToDelete === entry.id && (
                  <div
                    ...
                    className="absolute inset-0 bg-white/95 rounded-xl p-4 flex flex-col items-center justify-center text-center z-10 shadow-lg border border-slate-200"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs rounded-lg font-semibold transition-colors cursor-pointer shadow-xs"
                      >
                        Yes, Delete
                      </button>
                      <button
