...
![The four views](docs/screenshots/02-four-views.png)
...
![Journal history](docs/screenshots/06-history.png)
...
![Location picker](docs/screenshots/07-location-picker.png)
...
![Places Map](docs/screenshots/08-places-map.png)
...
![Places Map, dark](docs/screenshots/09-places-map-dark.png)
...
![Belief shifts](docs/screenshots/12-belief-shifts.png)

<!-- SCREENSHOT: A generated monthly retrospective card.
     Suggested file: docs/screenshots/13-monthly-summary.png -->
![Monthly summary](docs/screenshots/13-monthly-summary.png)
...
![Journal card](docs/screenshots/14-journal-card.png)
...
![Card rarities](docs/screenshots/15-card-rarities.png)
...
![Public card page](docs/screenshots/16-public-card.png)
...
![Integrations](docs/screenshots/17-integrations.png)
...
![Preferences](docs/screenshots/18-preferences.png)
...
![Google Cloud setup](docs/screenshots/19-gcp-console.png)
...
![Demo](docs/screenshots/20-demo.gif)
