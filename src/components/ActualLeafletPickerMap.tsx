...
export const ActualLeafletPickerMap: React.FC<ActualLeafletPickerMapProps> = ({
    ...
    const customIcon = L.divIcon({
      ...
      html: `
        <div class="relative cursor-grab active:cursor-grabbing transform -translate-x-1/2 -translate-y-full">
          <div class="w-9 h-9 rounded-full bg-accent shadow-xl border-2 border-white flex items-center justify-center text-accent-fg ring-4 ring-blue-400/30">
          ...
          <div class="w-2 h-2 bg-accent-strong rotate-45 mx-auto -mt-1 rounded-xs"></div>
        </div>
      `,
      iconSize: [36, 42],
      iconAnchor: [18, 42],
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-2 left-2 z-[400] bg-surface/90 backdrop-blur-xs border border-slate-200/80 px-2.5 py-1 rounded-md text-[11px] font-medium text-slate-700 shadow-2xs pointer-events-none flex items-center gap-1.5">
